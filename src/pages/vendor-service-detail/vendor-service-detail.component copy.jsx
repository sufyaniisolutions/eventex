...
export default function VendorServiceDetail() {
  const { vendorServiceFormId } = useParams();
  const [serviceFormDetail, setServiceFormDetail] = React.useState(null);
  ...
  function getCategories() {
    fetch(
      `http://localhost:8080/EventManagement/public/api/services/vendor-service-form/${vendorServiceFormId}`
    )
      .then((results) => results.json())
      .then((result) => {
        setServiceFormDetail(result.data);
      });
  }

  console.log(setServiceFormDetail);
  console.log(sections);
  const classes = {
    rowClass: "row pt-4 gy-2",
    colClass: "col-md-4 aos-init aos-animate",
  };
  console.log(vendorServiceFormId);
      ...
      <div className=" container">
        <div className="row ">
          ...
          <div className="col-sm-6 col-md-6 col-xs-6">
            ...
            <h2>{serviceFormDetail.address}</h2>
            <span>
              {" "}
          ...
          <div className="col-sm-6 col-md-6 col-xs-6">
            ...
            <div className="row">
              <div className="col-sm-6 col-md-6 col-xs-6">
                ...
                <br />
                <lable>
                  <img src="assets/img/icons/starge.svg" alt="default" /> Stage
                </lable>
              </div>
              <div className="col-sm-6 col-md-6 col-xs-6">
                <lable>
                ...
                <br />
                <lable>
                  <img src="assets/img/icons/tabel.svg" alt="default" /> Tables{" "}
                </lable>
                <br />
                <lable>
        ...
        <div className="row mt-5 gy-3">
          ...
          {sections.map((currElement, index) => (
